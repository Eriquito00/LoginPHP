...
<head>
    ...
    <script type="module" src="./js/ajax/RegisterData.js"></script>
</head>
...
<body class="log_reg_back">
    <form class="log_reg_form" method="POST" action="register" id="registerForm">
        ...
        <div>
            ...
            <input class="log_reg_input log_reg_shadow" id="email" name="email" type="email" placeholder="Introduce tu email" required>
        </div>

        <div>
            <label class="log_reg_label log_reg_lab_inp" for="password">Contraseña</label>
            <input class="log_reg_input log_reg_shadow" id="password" name="password" type="password" minlength="8" placeholder="Introduce tu contraseña" required>
        </div>

        <div>
            <label class="log_reg_label log_reg_lab_inp" for="repeat_password">Repite la contraseña</label>
            <input class="log_reg_input log_reg_shadow" id="repeat_password" name="repeat_password" type="password" placeholder="Repite tu contraseña" minlength="8" required>
        </div>
